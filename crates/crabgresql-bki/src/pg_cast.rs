...
/// and these are those numbers rather than invented ones — see [`OidCounter`]
/// for the rule and how it was checked. The counter therefore advances on
/// **every** entry, including the ones skipped above: a skipped cast still
/// spends its number upstream, and not spending it here would shift every OID
/// after it off PostgreSQL's.
