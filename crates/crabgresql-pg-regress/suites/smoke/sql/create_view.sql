...
-- names nothing takes the target type. A CASE offers "case" and an array
-- constructor "array", both of which a cast would override. The operand of a
-- cast node is parenthesised, and a subscript's index is deparsed rather than
-- echoed.
