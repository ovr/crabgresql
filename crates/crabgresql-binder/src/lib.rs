...
pub use expr::{
    BinOp, Binding, BoundAggregate, BoundDomain, BoundExpr, BoundWindowFunc, BoundWindowSpec,
    ColumnDefault, ExprSortKey, MinMaxKind, ParamCtx, ParamState, Scope, Subplan, SubplanId,
...
pub use functions::{
    AclClass, AggFn, ArgForm, GeoFn, InfoSchemaTypeAttr, JsonFn, JsonPathFn, PrivCall, ScalarFn,
    TableFn, TsFn, WindowFn, lookup_table_fn, routine_params,
};
...
pub use plan::{
    ...
    lateral_input_slots, output_columns_of, plan_contains_volatile_fn, plan_has_outer_refs,
    plan_needs_xid, plan_outer_ref_slots, substitute_outer, substitute_outer_exprs,
    substitute_params,
};
